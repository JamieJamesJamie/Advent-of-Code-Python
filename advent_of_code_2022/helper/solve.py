...
from advent_of_code_2022.helper.download_files import read_file
from advent_of_code_2022.helper.solver import Solver


def solve(input_path: Path, day: int) -> tuple[str, str]:
    """
    ...
    """
    puzzle_input = read_file(input_path=input_path, day=day)
