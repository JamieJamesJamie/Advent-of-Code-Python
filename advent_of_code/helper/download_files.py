...
def download(output_path: Path, year: int, day: int):
    ...
    If file_name starts with "input", then the puzzle input is downloaded and written to
    the file. Otherwise, the example input is downloaded and written to the file.
